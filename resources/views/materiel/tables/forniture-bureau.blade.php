<!--<div id="t4table" class="table-editable"></span>-->
<table id="forniture-bureau" class="table table-bordered table-responsive-md table-striped text-center ">
    <thead>
        <tr>
