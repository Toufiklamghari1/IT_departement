...
<div class="modal fade" id="modalRemove" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    aria-hidden="true">
    <div class="modal-dialog modal-sm modal-notify" style="max-width:390px !important" role="document">
        <!--Content-->
        <div class="modal-content border border-danger text-center">
            ...
            <div class="modal-header d-flex justify-content-center border-bottom border-white">
                <h4 class="modal-title w-100 font-weight-bold text-white">Supprimer un Enseignant</h4>
            </div>

            <!--Body-->
            <div class="modal-body  text-white mb-2">
                <span>Suprimer l'Enseignant : <span id="person-name"></span> ?</span>
            ...
            <div class="modal-footer flex-center">
                ...
                <a type="button" id="archiver" class="btn  btn-success">Archiver</a>
